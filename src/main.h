...
static const int LAST_POW_BLOCK = 10300;
...
static const int64_t MAX_MONEY = 1236000 * COIN;
...
static const uint256 hashGenesisBlock("0x000005a2c4b7492ad8216679318b5f1357c6386557bac60aecdcb38228d33d0f");
static const uint256 hashGenesisBlockTestNet("0x000005a2c4b7492ad8216679318b5f1357c6386557bac60aecdcb38228d33d0f");
...
public:
    ...
    {
        // FIFAWCCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // FIFAWCCoin: get transaction coin age
...
public:
    ...
    // FIFAWCCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // FIFAWCCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // FIFAWCCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // FIFAWCCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // FIFAWCCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // FIFAWCCoin: block index flags
    enum  
    {
